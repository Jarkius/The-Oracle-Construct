...
# ============================================
# Phase 3: Extract Core Workflows (4 only)
# ============================================
echo -e "${GREEN}[3/6] Extracting core workflows (4)...${NC}"

CORE_WORKFLOWS="oracle rrr learn commit"
...
# Also copy wisdom (part of learn loop)
if [[ -f "$SOURCE_DIR/.agent/workflows/wisdom.md" ]]; then
    cp "$SOURCE_DIR/.agent/workflows/wisdom.md" "$TARGET_REPO/.agent/workflows/"
    echo "  ✓ wisdom.md"
fi

# Copy corresponding commands
for workflow in $CORE_WORKFLOWS wisdom; do
