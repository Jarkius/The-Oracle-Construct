...
SNAPSHOT_FILE="$PROJECT_ROOT/psi/state/pulse/context-snapshot.json"
COMPRESSED_FILE="$PROJECT_ROOT/psi/state/pulse/compressed-context.txt"
PRIORITIES_FILE="$PROJECT_ROOT/psi/state/pulse/priorities.json"
...
Output files:
  psi/state/pulse/context-snapshot.json   — Structured event extraction
  psi/state/pulse/compressed-context.txt  — Human-readable compressed summary
  psi/state/pulse/priorities.json         — Ranked priority list
HELP
}
