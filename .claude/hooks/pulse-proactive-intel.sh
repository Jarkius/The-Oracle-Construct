...
PATTERNS_FILE="$PROJECT_ROOT/psi/pulse/patterns.json"
TASKS_FILE="$PROJECT_ROOT/psi/memory/tasks/active.json"
DISPATCH_LOG="$PROJECT_ROOT/psi/pulse/dispatch-log.jsonl"
OUTCOMES_LOG="$PROJECT_ROOT/psi/pulse/dispatch-outcomes.jsonl"
INTEL_FILE="$PROJECT_ROOT/psi/pulse/proactive-intel.json"
