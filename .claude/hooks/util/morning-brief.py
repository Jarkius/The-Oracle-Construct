...
- Focus (psi/state/focus.md)
- Tasks (psi/memory/tasks/active.json)
- Events (psi/state/pulse/events.jsonl — recent)
- Patterns (psi/state/pulse/patterns.json)
- Recommendations (psi/state/pulse/recommendations.json)
- Context Profile (psi/state/pulse/context-profile.json)
- Reminders (psi/state/pulse/reminders.json)
