...
heal)
    ...
    STATE_FILES=(
        "psi/state/pulse/patterns.json"
        "psi/state/pulse/recommendations.json"
        "psi/state/pulse/context-profile.json"
        "psi/state/pulse/reminders.json"
        "psi/state/pulse/dispatch-rules.json"
...
" 2>/dev/null | grep -q "repaired"; then
    ...
    JSONL_FILES=(
        ...
        "psi/state/pulse/dispatch-log.jsonl"
        "psi/state/pulse/dispatch-outcomes.jsonl"
    )
